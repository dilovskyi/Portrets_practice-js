...
const accordion = triggersSelector => {
  ...
  btns.forEach(element => {
    element.addEventListener("click", function (e) {
      ...
      content.classList.toggle("active-content"); // content.classList.add('"animated", "fadeInDown"');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_requsts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/requsts */ "./src/js/services/requsts.js");
...
const calc = (size, material, options, promocode, result) => {
  ...
  const calcFunction = () => {
    ...
    } else if (promocodeBlock === "IWANTINPORTANT") {
...
const form = () => {
  ...
  forms.forEach(form => {
    form.addEventListener("submit", e => {
      ...
      Object(_services_requsts__WEBPACK_IMPORTED_MODULE_0__["postData"])(api, formData).then(res => {
        console.log(res);
      }).then(() => {
...
const showMoreCards = (trigger, wrapper) => {
  ...
  btn.addEventListener("click", () => {
    Object(_services_requsts__WEBPACK_IMPORTED_MODULE_0__["getData"])("http://localhost:3000/styles").then(res => {
